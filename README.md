...
백엔드 개발자가 배워야 할 양질의 공부 자료들을 정리하기 위한 저장소입니다.<br/>
여러분들의 학습과 성장에 도움이 되기를 바랍니다.

카테고리별 난이도와 효율성을 고려하여 봐야 할 순서는 위에서부터 아래로 정렬하였습니다.

저도 아직 모든 자료를 다 본 것이 아니기 때문에, 책정한 우선순위가 부정확할 수 있습니다. <br/>
우선순위 등의 아이디어는 Issues를 통해 제공해주시면 감사하겠습니다!
